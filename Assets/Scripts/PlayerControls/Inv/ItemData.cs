...
public static class ItemData
{
    public static Item CreateItem(int ItemID)
    {
        ...
        //creates a item, and fills in the values from the item ID information
        string name = "";
        int value = 0;
        string description = "";
        int damage = 0;
        ...
        //all the information that applies to each item, so the damage value, and the description, etc..
        switch (ItemID)
        {
        ...
        //temporary item now creates a new item with the name, item id, value, description etc...
        Item temp = new Item
        {
            Name = name,
            Id = ItemID,
